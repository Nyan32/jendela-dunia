...
<div class="p-2 d-flex justify-content-center flex-column align-items-center">
    <label class="p-1 d-flex align-items-center rounded-pill border-1 color-3 style-2 w-100 search-item" for="search" style="max-width: 500px;">
        <div class="p-2">
            <i class="fa-solid fa-magnifying-glass"></i>
        </div>
        <input type="text" name="search" class="flex-grow-1 rounded-pill color-3 border-0" style="outline: none;" placeholder="title, author or publisher" id="search">
        <div class="p-2">
...
<div class="p-2">
    <div class="d-flex align-items-center justify-content-between flex-wrap">
        ...
        <div class="col-12 col-md-4 d-flex align-items-center justify-content-end">
            <div class="p-2 col-6">
                <div class="select-box position-relative d-flex" data-type="sort">
    ...
    <!-- Daftar buku-buku -->
    <div class="d-flex flex-wrap" id="daftarBukuCont" style="color: var(--color-3)">
        <?php
        if (count($bookData) > 0) {
